    ...
    <div class="container-fluid" id="card" style="padding: 25px; background-color: #F3F3F3;">
        ...
        <div class="container " data-aos="fade-up">
            <div class="row ">
                ...
                <div class="col-md-6 col-sm-6 text-center" data-aos="fade-up" data-aos-delay="100">
                    <div class="about-col">
                        <img src="assets/image/hybrid_fund.png" alt="" width="100%">
                    </div>
                </div>
                    ...
                    <div data-aos="fade-up">
                           ...
                           <div class="card" id="card">
                               <div class="card-header bg-secondry  font-weight-bold text-center">
                                   <b>Liquid Investments   </b>
                               </div>
                               <div class="card-body">
                                  <h5><b>Liquid Investments   </b></h5>
        ...
        <!-- card for test -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-center">
                            <img src="assets/image/risk_mng_sym.png" alt="" width="100%">
                        </div>
                    </div><!--End row-->
                </div><!--End container-->
            ...
            <div style="padding: 15px; background: linear-gradient(to right, #f7f8f8, #f2f3f4);"  data-aos="fade-up">
                <div class="container">
                    <h4><b>What is Liquid Investments?</b></h4>
                    ...
                    <h4<b>Features of Liquid Investments</b></h4>
                        <ul>
