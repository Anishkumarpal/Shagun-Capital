    ...
    <div class="container-fluid" id="card" style="padding: 25px; background-color: #F3F3F3;">
        ...
        <div class="container " data-aos="fade-up">
            <div class="row ">
                ...
                <div class="col-md-6 col-sm-6 text-center" data-aos="fade-up" data-aos-delay="100">
                    <div class="about-col">
                        <img src="assets/image/retirement_planning.png" alt="" width="100%">
                    </div>
                </div>
        ...
        <!-- card for test -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-center">
                            <img src="assets/image/Pension1.png" alt="" width="100%">
                        </div>
                    </div><!--End row-->
                </div><!--End container-->
            ...
            <div style="padding: 15px; background: linear-gradient(to right, #f7f8f8, #f2f3f4);"  data-aos="fade-up">
                <div class="container">
                    <h4><b>What is Deposits Planning?</b></h4>
