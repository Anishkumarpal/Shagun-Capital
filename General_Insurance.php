        ...
        <div class="container " data-aos="fade-up">
            <div class="row ">
                ...
                <div class="col-md-6 col-sm-6 text-center" data-aos="fade-up" data-aos-delay="100">
                    <div class="about-col">
                        <img src="assets/image/general_insurance.png" alt="" width="100%">
                    </div>
                </div>
        ...
        <!-- card for test -->
            ...
            <div style=" background-color: #F3F3F3; padding:30px;" data-aos="fade-right">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4><b>Health Insurance Planning</b></h4>
            ...
            <div style="padding: 15px; background: linear-gradient(to right, #f7f8f8, #f2f9d7);"  data-aos="fade-up">
                <div class="container">
                    <h4><b>What is Insurance Planning?</b></h4>
