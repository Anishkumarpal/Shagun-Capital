...
<main id="main" data-aos="fade-up">
        ...
        <div class="container " data-aos="fade-up">
            <div class="row ">
                ...
                <div class="col-md-7 col-sm-6 text-center" data-aos="fade-up" data-aos-delay="100">
                    <div class="about-col">
                        <img src="assets/image/invest_mangt.png" alt="" width="100%">
                    </div>
                </div>
    ...
    <div style="padding: 15px; background: linear-gradient(to right, #f7f8f8, #acbb78);" data-aos="fade-up">
        <div class="container">
            <h4><b>What is Investment_Management?</b></h4>
            ...
            <h4<b>Features of Investment Management. </b></h4>
                <ul>
    ...
    <div class="container">
        <div style="background: linear-gradient(to right, #1fa2ff, #12d8fa, #a6ffcb); padding: 30px;">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <h4><b>Benefits of Investment Management.</b></h4>
